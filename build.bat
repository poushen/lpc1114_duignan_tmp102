...
arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -I. -g -c .\driver\i2c_tmp102.c -o .\out\i2c_tmp102.o
arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -I. -I.\driver -g -c main.c -o .\out\main.o
arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb .\out\init.o .\out\led.o .\out\uart.o .\out\systick.o .\out\i2c.o .\out\i2c_eeprom.o .\out\ftoa.o .\out\oled_font.o .\out\i2c_oled.o .\out\i2c_tmp102.o .\out\main.o -L "C:\Program Files (x86)\GNU Tools ARM Embedded\5.4 2016q2\lib\gcc\arm-none-eabi\5.4.1\armv6-m" -lgcc -T linker_script.ld -Wl,-Map=.\out\main.map -nostartfiles -o .\out\main.elf
